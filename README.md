Staynest - an Airbnb-like MVP, using vanilla JavaScript, HTML, and CSS along with Supabase for auth, storage and the database (PostgreSQL). Deployed with Vercel.
